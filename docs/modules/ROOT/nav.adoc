...
** xref:config/current/config.adoc[Configurations]
** xref:config/legacy/legacy.adoc[Legacy Configurations (Satisfactory 1.1 and before)]
*** xref:config/legacy/DiscIT.adoc[DiscIT]
*** xref:config/legacy/Monitoring.adoc[Monitoring]
*** xref:config/legacy/Serial.adoc[Serial Devices]
*** xref:config/legacy/Web.adoc[Web Server]
...
**** xref:json/Read/getSPWN.adoc[getSPWN]
...
**** xref:json/Read/getCrateInv.adoc[getCrateInv]

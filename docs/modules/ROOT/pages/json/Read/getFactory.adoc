...
| {depth}  Amount | String | Number of items to be produced.
...
| {depth}  Name | String | Name of the item.
| {depth}  ClassName | String | ClassName of the item.
| {depth}  Amount | String | Number of items required for product.
...
{set:inventory-description:A list of items in the input inventory.}
include::../Models/_inventoryItem.adoc[]

// output inventory
{set:inventory-name:OutputInventory}
{set:inventory-description:A list of items in the output inventory.}
include::../Models/_inventoryItem.adoc[]

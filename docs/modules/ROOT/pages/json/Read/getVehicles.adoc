...
Gets a list of all vehicles (explorers, tractors, trucks, factory carts, etc.).
...
| PathName | String | Name of Saved Path Assigned
| Status | String | Vehicle Status
| Driver | String | Player Name of Vehicle Driver
...
| FuelConsumption | Float | Fuel Consumption in MegaWatts

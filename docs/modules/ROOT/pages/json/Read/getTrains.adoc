...
| SelfDriving | enum String | Error codes for the self driving locomotives (See below ESelfDrivingLocomotiveError)
| Docking | enum String | Docked state (See below ETrainDockingState)
| Path | enum String | Error codes for the extended path finding diagnostics (See below EPathDiagnosticsError)
...
==== enum class ESelfDrivingLocomotiveError
[cols="1,1"]
|===
|*enum*|*Name*
...
==== enum class EPathDiagnosticsError
[cols="1,1"]
|===
|*enum*|*Name*

...
You may also have your own delay on your serial device and send API Endpoints to FRM to get an output. URIs may be sent manually or programmicly, but require a "copy/paste" approach. +

...
FRM serial communication can be configured on a serial port of your choosing (Default: COM3). This can be modified by changing the respective configuration value in either the Server Manager for Dedicated Servers or the Main Menu Options for Single-Player, Hosted Sessions, and Client Sessions.

L.Control.Measure = L.Control.extend({
    ...
    onAdd: function (map) {
      ...
      this._createButton('<i class="fas fa-ruler-vertical"></i>', 'Measure',
    ...
    _mouseMove: function (e) {
      ...
      if (this._tooltip) {
        ...
        // calc dist in meter
        var distance = Math.sqrt(Math.pow(e.latlng.lat - this._lastPoint.lat, 2) + Math.pow(e.latlng.lng - this._lastPoint.lng, 2)) * 0.01;
    ...
    _mouseClick: function (e) {
      ...
      if (this._lastPoint && this._tooltip) {
        ...
        console.info(this._lastPoint, e, distance);
      }
    ...
    _formatDistance: function (val) {
      ...
      if (val < 1000) {
        ...
        return Math.round((val * 0.01) * 100) * 0.01 + 'km'
      }
    },
